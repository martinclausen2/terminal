...
// ************************ Time calculate Settings *************************
	...
	// your implementation
#define CLI_GetUs()					((float)HAL_GetTick() * 1000)	// System time in us
#define CLI_GetFastUs()				(HAL_GetTick() << 10)			// System time in us (not exact)
#define CLI_GetFastMs()				(HAL_GetTick())					// System time in ms (not exact)
